...
// Asegúrate de importar el hook desde la ruta donde lo creaste
import { useNowPlaying } from "@/hooks/useTrackDetails"; 

export default function NowPlayingSidebar() {
    // Llamamos al hook y extraemos todo lo necesario
    const {
        currentTrack,
        videoId,
        artistInfo,
