...
export function Moon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            height="20"
            viewBox="0 0 24 24"
            {...props} // Permite sobreescribir atributos
        >
            <g fillOpacity="0">
                <path d="M15.22 6.03l2.53 -1.94l-3.19 -0.09l-1.06 -3l-1.06 3l-3.19 0.09l2.53 1.94l-0.91 3.06l2.63 -1.81l2.63 1.81l-0.91 -3.06Z" fill="white">
                    <animate fill="freeze" attributeName="fill-opacity" begin="0.7s" dur="0.4s" values="0;1" />
                </path>

                <path d="M19.61 12.25l1.64 -1.25l-2.06 -0.05l-0.69 -1.95l-0.69 1.95l-2.06 0.05l1.64 1.25l-0.59 1.98l1.7 -1.17l1.7 1.17l-0.59 -1.98Z" fill="white">
